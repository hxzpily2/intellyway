...
class PDFAJAXViewer {
	...
	public static function getContent($file) {
			...
			$data .= "<button id='zoomhtml' dojoType='dijit.form.DropDownButton' label='100%'>	
				<div dojoType='dijit.Menu' id='editMenu2' style='display: none;'>
					<div dojoType='dijit.MenuItem'				
						onClick=\"javascript:commun.changeResolution(200,'" . RessourceBundle::get ( 'pdfviewer.relatif.path.base' ) . "/copix/bedreamy/action/action.class.php','" . RessourceBundle::get ( 'pdfviewer.path.assets' ) . "')\">
						200%
					</div>
					<div dojoType='dijit.MenuItem'				
						onClick=\"javascript:commun.changeResolution(180,'" . RessourceBundle::get ( 'pdfviewer.relatif.path.base' ) . "/copix/bedreamy/action/action.class.php','" . RessourceBundle::get ( 'pdfviewer.path.assets' ) . "')\">
						180%
					</div>
					<div dojoType='dijit.MenuItem'				
						onClick=\"javascript:commun.changeResolution(160,'" . RessourceBundle::get ( 'pdfviewer.relatif.path.base' ) . "/copix/bedreamy/action/action.class.php','" . RessourceBundle::get ( 'pdfviewer.path.assets' ) . "')\">
						160%
					</div>
					<div dojoType='dijit.MenuItem'				
						onClick=\"javascript:commun.changeResolution(140,'" . RessourceBundle::get ( 'pdfviewer.relatif.path.base' ) . "/copix/bedreamy/action/action.class.php','" . RessourceBundle::get ( 'pdfviewer.path.assets' ) . "')\">
						140%
					</div>
					<div dojoType='dijit.MenuItem'				
						onClick=\"javascript:commun.changeResolution(120,'" . RessourceBundle::get ( 'pdfviewer.relatif.path.base' ) . "/copix/bedreamy/action/action.class.php','" . RessourceBundle::get ( 'pdfviewer.path.assets' ) . "')\">
						120%
					</div>
					<div dojoType='dijit.MenuItem'				
		...
		<div id='page' style='overflow: scroll;'>
		 <div>
			<img src='" . PDFAJAXViewer::generatePageFromImageMagick ( 1, PDFAJAXViewer::$DEFAULT_RESOL ) . "'/>
		 </div>		
		</div>
