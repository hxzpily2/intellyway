...
/**
 * AmjiCastResponse form base class.
 *
 * @method AmjiCastResponse getObject() Returns the current form's model object
 *
 * @package    amji
 * @subpackage form
 ...
 */
abstract class BaseAmjiCastResponseForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('amji_cast_response[%s]');
