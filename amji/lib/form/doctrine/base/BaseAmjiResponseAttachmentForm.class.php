...
/**
 * AmjiResponseAttachment form base class.
 *
 * @method AmjiResponseAttachment getObject() Returns the current form's model object
 *
 * @package    amji
 * @subpackage form
 ...
 */
abstract class BaseAmjiResponseAttachmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('amji_response_attachment[%s]');
