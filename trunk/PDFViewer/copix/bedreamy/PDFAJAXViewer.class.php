...
class PDFAJAXViewer{
	...
	public static function getContent(){		
		...
		if($params[PDFAJAXViewer::TREE_BOOKMARK]==TRUE){
			...
			splitter='true'>".
			"<div dojoType='dijit.layout.ContentPane' title='Sommaire'>";
	...
	public static function includeDOJO(){
		echo " <head> ".
			...
			" $('#page').scrollview({".
			    "grab:'".ResourceBundle::get('pdfviewer.path.assets')."/js/scroller/images/openhand.cur',".
			    "grabbing:'".ResourceBundle::get('pdfviewer.path.assets')."/js/scroller/images/closedhand.cur'".
			" });".					
