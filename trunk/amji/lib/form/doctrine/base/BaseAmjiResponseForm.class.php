...
/**
 * AmjiResponse form base class.
 *
 * @method AmjiResponse getObject() Returns the current form's model object
 *
 * @package    amji
 * @subpackage form
 ...
 */
abstract class BaseAmjiResponseForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idrequest'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('AmjiRequest'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'idrequest'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AmjiRequest'))),
      'idresponse'      => new sfValidatorInteger(array('required' => false)),
      'created_at'      => new sfValidatorDateTime(),
      'updated_at'      => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('amji_response[%s]');
