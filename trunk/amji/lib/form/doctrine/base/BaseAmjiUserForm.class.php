...
abstract class BaseAmjiUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'humeur'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'civilite'      => new sfValidatorString(array('max_length' => 5, 'required' => false)),
      'sexe'          => new sfValidatorString(array('max_length' => 1, 'required' => false)),
      'humeur'        => new sfValidatorString(array('max_length' => 100, 'required' => false)),
