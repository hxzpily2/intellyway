...
ALTER TABLE COMPTES_USER ADD ( CONSTRAINT PK_COMPTES_USER_FK FOREIGN KEY (CPT_NUM) REFERENCES T_CPT (CPT_NUM) );
ALTER TABLE COMPTES_USER ADD ( CONSTRAINT PK_USER_COMPTES_FK FOREIGN KEY (ID_USER) REFERENCES ACCOUNT_USER (ID_USER) );