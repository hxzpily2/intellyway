 ...
 * a fully-qualified URL and this is also supported.</li>
 ...
 * {@link org.acegisecurity.event.authentication.InteractiveAuthenticationSuccessEvent}
 ...
 *          vishalpuri $
 */
public abstract class AccountAbstractProcessingFilter extends DispatchAction implements Filter,
	...
	protected String determineFailureUrl(HttpServletRequest request,
		...
		return exceptionMappings.getProperty(failed.getClass().getName(),
