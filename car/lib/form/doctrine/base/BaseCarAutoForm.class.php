...
abstract class BaseCarAutoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'urgent'         => new sfWidgetFormInputText(),
      'nonfumeur'      => new sfWidgetFormInputText(),
      'garaged'        => new sfWidgetFormInputText(),
      'hand'           => new sfWidgetFormInputText(),
      'anneegarantie'  => new sfWidgetFormInputText(),
      'title'          => new sfWidgetFormTextarea(),
      'source'         => new sfWidgetFormTextarea(),
      'telsource1'     => new sfWidgetFormTextarea(),
      'telsource2'     => new sfWidgetFormTextarea(),
      'adresse'        => new sfWidgetFormTextarea(),
      'url'            => new sfWidgetFormTextarea(),
      'extowner'       => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'adresse_ip'     => new sfValidatorString(array('required' => false)),
      ...
      'reprise'        => new sfValidatorInteger(array('required' => false)),
      'etranger'       => new sfValidatorInteger(array('required' => false)),
      'dedouane'       => new sfValidatorInteger(array('required' => false)),
      'garantie'       => new sfValidatorInteger(array('required' => false)),
      'urgent'         => new sfValidatorInteger(array('required' => false)),
      'nonfumeur'      => new sfValidatorInteger(array('required' => false)),
      'garaged'        => new sfValidatorInteger(array('required' => false)),
      'hand'           => new sfValidatorInteger(array('required' => false)),
      'anneegarantie'  => new sfValidatorInteger(array('required' => false)),
      'title'          => new sfValidatorString(array('required' => false)),
      'source'         => new sfValidatorString(array('required' => false)),
      'telsource1'     => new sfValidatorString(array('required' => false)),
      'telsource2'     => new sfValidatorString(array('required' => false)),
      'adresse'        => new sfValidatorString(array('required' => false)),
      'url'            => new sfValidatorString(array('required' => false)),
      'extowner'       => new sfValidatorString(array('required' => false)),
