...
/**
 * CarPrestations form base class.
 *
 * @method CarPrestations getObject() Returns the current form's model object
 *
 * @package    car
 * @subpackage form
 ...
 */
abstract class BaseCarPrestationsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_prestations[%s]');
