...
/**
 * CarAdresseGar filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarAdresseGarFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'idgar'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CarGar'), 'column' => 'idgar')),
    ...
    $this->widgetSchema->setNameFormat('car_adresse_gar_filters[%s]');
