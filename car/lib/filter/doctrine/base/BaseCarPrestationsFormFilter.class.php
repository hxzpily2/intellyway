...
/**
 * CarPrestations filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarPrestationsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_prestations_filters[%s]');
