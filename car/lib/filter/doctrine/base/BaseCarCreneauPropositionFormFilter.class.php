...
/**
 * CarCreneauProposition filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarCreneauPropositionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_creneau_proposition_filters[%s]');
