...
/**
 * CarAccessoireExt filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarAccessoireExtFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_accessoire_ext_filters[%s]');
