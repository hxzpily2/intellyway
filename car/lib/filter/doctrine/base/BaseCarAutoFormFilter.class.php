...
abstract class BaseCarAutoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'adresse_ip'     => new sfWidgetFormFilterInput(),
      ...
      'reprise'        => new sfWidgetFormFilterInput(),
      'etranger'       => new sfWidgetFormFilterInput(),
      'dedouane'       => new sfWidgetFormFilterInput(),
      'garantie'       => new sfWidgetFormFilterInput(),
      'urgent'         => new sfWidgetFormFilterInput(),
      'nonfumeur'      => new sfWidgetFormFilterInput(),
      'garaged'        => new sfWidgetFormFilterInput(),
      'hand'           => new sfWidgetFormFilterInput(),
      'anneegarantie'  => new sfWidgetFormFilterInput(),
      'title'          => new sfWidgetFormFilterInput(),
      'source'         => new sfWidgetFormFilterInput(),
      'telsource1'     => new sfWidgetFormFilterInput(),
      'telsource2'     => new sfWidgetFormFilterInput(),
      'adresse'        => new sfWidgetFormFilterInput(),
      'url'            => new sfWidgetFormFilterInput(),
      'extowner'       => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'telsource1'     => new sfValidatorPass(array('required' => false)),
      'telsource2'     => new sfValidatorPass(array('required' => false)),
      'adresse'        => new sfValidatorPass(array('required' => false)),
      'url'            => new sfValidatorPass(array('required' => false)),
      'extowner'       => new sfValidatorPass(array('required' => false)),
