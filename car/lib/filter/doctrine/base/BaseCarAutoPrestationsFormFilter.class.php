...
/**
 * CarAutoPrestations filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarAutoPrestationsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_auto_prestations_filters[%s]');
