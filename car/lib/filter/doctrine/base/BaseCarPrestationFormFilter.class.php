...
/**
 * CarPrestation filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarPrestationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_prestation_filters[%s]');
