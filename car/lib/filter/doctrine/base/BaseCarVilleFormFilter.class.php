...
/**
 * CarVille filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarVilleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('car_ville_filters[%s]');
