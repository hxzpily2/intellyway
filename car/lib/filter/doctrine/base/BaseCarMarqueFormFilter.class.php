...
/**
 * CarMarque filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarMarqueFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'notesav'        => new sfWidgetFormFilterInput(),
      'nbnotesav'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'notesav'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nbnotesav'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('car_marque_filters[%s]');
