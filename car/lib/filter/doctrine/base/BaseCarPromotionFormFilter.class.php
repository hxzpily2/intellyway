...
/**
 * CarPromotion filter form base class.
 *
 * @package    car
 * @subpackage filter
 ...
 */
abstract class BaseCarPromotionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idpromotion' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'idpromotion' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'idcon'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CarCon'), 'column' => 'idcon')),
    ...
    $this->widgetSchema->setNameFormat('car_promotion_filters[%s]');
