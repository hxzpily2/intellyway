<div class="users form register-block <?php echo !empty($this->data['User']['is_requested']) ? 'js-login-response ajax-login-block' : ''; ?>">
	...
	<?php
		...
		echo $form->input(Configure::read('user.using_to_login'));
