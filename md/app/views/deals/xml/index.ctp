  ...
  <deals>
    <?php 
		foreach($deals as $deal):
                ...
                $small_image_url = $html->getImageUrl('Deal', $deal['Attachment'], $image_options);
                $image_options = array(
                ...
                $medium_image_url = $html->getImageUrl('Deal', $deal['Attachment'], $image_options);
                $image_options = array(
                ...
                $large_image_url = $html->getImageUrl('Deal', $deal['Attachment'], $image_options);
		?>
            <deal>
                  ...
                  <price><?php echo $html->siteCurrencyFormat($html->cCurrency($deal['Deal']['discounted_price'],false));?></price>
                  <value><?php echo $html->siteCurrencyFormat($html->cCurrency($deal['Deal']['original_price'],false));?></value>
                  <discount_amount><?php echo $html->siteCurrencyFormat($html->cCurrency($deal['Deal']['savings'],false)); ?></discount_amount>
                  <discount_percent><?php echo $html->cInt($deal['Deal']['discount_percentage'],false) . "%"; ?></discount_percent>
                  <conditions>
                    ...
                    <details>
                      <detail><?php echo $html->cHtml($deal['Deal']['coupon_condition'],false);?>   </detail>
                    </details>
                  </conditions>
                </deal>
       <?php
