				...
				foreach($deals as $deal):
                  $deal_image = '';
					if(!empty($deal['Attachment'])):
						$deal_image = $html->showImage('Deal', $deal['Attachment'][0], array('dimension' => 'small_big_thumb', 'alt' => sprintf(__l('[Image: %s]'), $html->cText($deal['Deal']['name'], false)), 'title' => $html->cText($deal['Deal']['name'], false)));
					endif;
